                    ...
                    <div class="flex h-16 justify-between">
                        <div class="flex">
                            ...
                            >
                                ...
                                <NavLink
                                    v-if="isAdmin"
                                    :href="route('admin.update.master.materials.spreadsheet')"
                                    :active="route().current('admin.update.master.materials.spreadsheet')"
                                >
                                    Update Master Materials (Admin)
                                </NavLink>
                            </div>
                        </div>
