<script setup>
    ...
    function thisDownloadedNestingData(nestingData){
        ...
        if(nestingData){
            ...
            // Object.values(nestingData).forEach(item => {
            //     console.log("item",item.batch_id,props.batchId);
            // });

            console.log(rawData,props.batchId);
            if(rawData){
                data = rawData.data;
            }
        }
            ...
            <div class="dark:bg-gray-900 rounded-xl">
                <div class="pt-4 pb-4 mx-auto text-center">
                    ...
                    <div
                        ...
                        style="height:400px"
                    >
                        <p v-if="thisDownloadedNestingData(nestingData).projectsReadyForBatching.data.length > 0">
                            <h2 class="font-semibold">Included Projects:</h2>
                            <ul>
                                <li v-for="(project,index) in thisDownloadedNestingData(nestingData).projectsReadyForBatching.data">
                        ...
                        <div class="mt-5">
                            ...
                            Total Material = {{ (thisDownloadedNestingData(nestingData).usage.totalMaterial/1000).toLocaleString() }} m
                            <br>
                            Total Used Material = {{ (thisDownloadedNestingData(nestingData).usage.totalUsedMaterial/1000).toLocaleString() }} m
                            <br>
                            Total Waste = {{ (thisDownloadedNestingData(nestingData).usage.totalWaste/1000).toLocaleString() }} m
                            <br>
                            Efficiency = {{ thisDownloadedNestingData(nestingData).usage.efficiency }}
