...
it('would be a disaster if using offcuts that don’t exist', function () {});

it('would be a disaster if using offcuts that are allocated to another project', function () {});
...
it('would be a disaster if meterage nesting with an offcut was not working correctly', function () {});
